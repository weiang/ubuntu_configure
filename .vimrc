...
autocmd BufNewFile *.cc,*.cpp,*.[ch],*.sh,*.java,*.py,*.md exec ":call SetTitle()" 
...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+1, "\# Author: Weiang")
		call append(line(".")+2, "\# mail: weiang@mail.ustc.edu.cn") 
    ...
    elseif &filetype == 'mkd'
		...
		call append(line(".")+2, "	> Mail: weiang@mail.ustc.edu.cn ") 
		call append(line(".")+3, "	> Created Time: ".strftime("%c")) 
		call append(line(".")+4, "    > Describition: ")
		call append(line(".")+5, " ************************************************************************/") 
		call append(line(".")+6, "")
	endif
	if &filetype == 'cpp' || 'cc' 
